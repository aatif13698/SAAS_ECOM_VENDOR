...
const MobileMenu = ({ className = "custom-class" }) => {
  ...
  return (
    <div
      className={`${className} fixed  top-0 bg-white dark:bg-darkSecondary shadow-lg  h-full   w-[248px]`}
    >
      <div className="logo-segment flex justify-between items-center bg-white dark:bg-darkSecondary z-[9] h-[85px]  px-4 ">
        <Link to="/dashboard">
