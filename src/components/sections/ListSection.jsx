...
function ListSection({ centered, noFade, scrollContent }) {
    ...
    const fetchSections = async () => {
        try {
            setPending(true);
            const response = await statementService.listSection();
            ...
            <Draggable key={section._id} draggableId={section._id} index={index}>
                {(provided) => (
                    ...
                    >
                        ...
                        <p className="text-sm mb-2">Template: {section.template} | Type: {section.type}</p>
                        <div className="mb-2">
