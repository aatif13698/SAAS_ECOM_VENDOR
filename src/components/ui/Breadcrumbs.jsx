...
const Breadcrumbs = () => {
  ...
  const [translatedLocationName, setTranslatedLocationName] = useState()
  useEffect(() => {
  ...
  // writting condition for location name
  ...
  useEffect(() => {
    ...
    // Update translatedLocationName based on locationName
    setTranslatedLocationName(translations[locationName]);

  }, [locationName]);
  // console.log("translatedLocationName",translatedLocationName);
