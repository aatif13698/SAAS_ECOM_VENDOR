...
const getList = async (page, keyWord, perPage) => {
    ...
    try {
        const response = await axios.get(
            `${import.meta.env.VITE_BASE_URL}/api/vendor/warehouse/listWarehouse?keyword=${keyWord}&perPage=${perPage}&page=${page}&clientId=${clientId}`,
            {
                headers: {
                    Authorization: `Bearer ${authToken}`,
                }
...
const createWarehouse = async (data) => {
    ...
    return await axios.post(`${import.meta.env.VITE_BASE_URL}/api/vendor/warehouse/createWarehouse`, data, {
        headers: {
            Authorization: `Bearer ${authToken}`,
        }
...
const deleteOne = async (data) => {
    ...
    return await axios.post(`${import.meta.env.VITE_BASE_URL}/api/vendor/warehouse/softDeleteWarehouse`, { ...data, clientId: clientId, softDelete: "0" }, {
        headers: {
            Authorization: `Bearer ${authToken}`,
        }
...
const getOne = async (id) => {
    ...
    const response = await axios.get(`${import.meta.env.VITE_BASE_URL}/api/vendor/warehouse/Warehouse/${clinetId}/${id}`, {
        headers: {
            Authorization: `Bearer ${authToken}`,
        }
...
const activeInactive = async (data) => {
    ...
    return await axios.post(`${import.meta.env.VITE_BASE_URL}/api/vendor/warehouse/activeInactiveWarehouse`, data, {
        headers: {
            Authorization: `Bearer ${authToken}`,
        }
    });
