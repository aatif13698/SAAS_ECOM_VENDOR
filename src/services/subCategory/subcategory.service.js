...
const create = async (data) => {
    ...
    return await axios.post(`${import.meta.env.VITE_BASE_URL}/api/vendor/subCategory/createSubCategory`, data, {
        headers: {
...
const getAllList = async ({ page, keyword, perPage }) => {
    ...
    const response = await axios.get(`${import.meta.env.VITE_BASE_URL}/api/vendor/subCategory/listSubCategory?keyword=${keyword}&&page=${page}&&perPage=${perPage}&&clientId=${clientId}`, {
        headers: {
            Authorization: `Bearer ${authToken}`,
        }
