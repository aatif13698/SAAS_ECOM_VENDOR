...
export const performaSlice = createSlice({
    name: "addPerforma",
    ...
    reducers: {
        ...
        setspNumber: (state, action) => {
            state.spNumber = action.payload
        },
        setspDate: (state, action) => {
            state.spDate = action.payload
        },
