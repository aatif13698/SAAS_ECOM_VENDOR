...
// import { setItemsList } from '@/store/slices/quotation/quotationSlice';
...
//                                                                             <th className="px-4 w-[10px] bg-red-200 py-2">Select</th>
//                                                                             <th className="px-4 py-2 bg-green-300">Item</th>
//                                                                             <th className="px-4 py-2 w-[100px] bg-yellow-300">Unit Price</th>
//                                                                             <th className="px-4 py-2 w-[100px] bg-orange-300">Has Dis.</th>
//                                                                             <th className="px-4 py-2 w-[100px] bg-pink-300">% Dis.</th>
