...
import { removeItemsList, resetQuotation, setAccountNumber, setBankName, setBranch, setBranchName, setBusinessUnit, setIfscCode, setIsInterState, setItemsList, setLevel, setNotes, setPaidAmount, setsiDate, setsiNumber, setShippingAddress, setSupplier, setWarehouse, setPaymentMethod, setPayedFrom, setBalance } from '../../store/slices/saleInvoice/saleInvoiceSlice';
...
import SaleProductListModel from './SaleProductListModel';
...
const SaleInvoice = ({ noFade, scrollContent }) => {
    ...
    useEffect(() => {
        ...
        setFormData((prev) => ({
            ...
            siDate: purhcaseOrderDraftData?.siDate,
    ...
    const handleInputChange = (e, section) => {
        ...
        if (section) {
            ...
            if (name == "siNumber") {
                dispatch(setsiNumber(value))
            }
            if (name == "siDate") {
                dispatch(setsiDate(value))
            }
            if (name === "notes") {
    ...
    return (
        <div className=' bg-white dark:bg-darkSecondary rounded-lg relative'>
            <div className='bg-white shadow-sm flex gap-2 justify-between dark:bg-darkSecondary sticky z-[99] top-[3.54rem] p-4  border-b-2'>
                <div>
                    <h2 className="text-xl font-semibold   text-gray-700">Create Sale Invoice</h2>
                </div>
                        ...
                        />
                            ...
                            <div className="bg-white dark:bg-transparent lg:col-span-1 md:col-span-2 rounded-lg border border-gray-200">
                                ...
                                <div className="h-[80%] p-2 grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        <label className="block text-sm font-medium text-gray-700 mb-1">Sale Inv No</label>
                                        <input
                                            type="text"
                                            name="siNumber"
                                    ...
                                    <div>
                                        <label className="block text-sm font-medium text-gray-700 mb-1">Sale Inv Date</label>
                                        <input
                                            type="date"
                                            name="siDate"
                                ...
                                <tbody className="bg-white dark:bg-gray-900 divide-y divide-gray-200">
                                    {formData.items.map((item, index) => (
                                        <tr key={index} className="hover:bg-gray-50 dark:hover:bg-gray-800">
                                            ...
                                            <td className="py-2 px-4 border border-gray-300 text-right text-sm  pr-3 font-bold">
                  ...
                  <div className="flex justify-end">
                    ...
                    />
                            ...
                            <section className="space-y-6">
                                <h2 className="text-lg font-semibold text-gray-800">Payment Received Details</h2>
