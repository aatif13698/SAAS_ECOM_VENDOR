...
function Pricing2({ centered, noFade, scrollContent }) {
    ...
    function handleSaveAndMore(e) {
        ...
        let errorCount = 0;
        const errors = {};
        const { quantity, unitPrice, hasDiscount, discountPercent, isCustomerSpecific, customerId } = pricing;
        if (!quantity) {
            errorCount++
            errors["quantity"] = "Quantity is required."
        } else {
        ...
        if (isCustomerSpecific && !customerId) {
            errorCount++
        ...
        if (errorCount == 0) {
            setPricingArray((prev) => ([...prev, {
                ...
                customerId: isCustomerSpecific ? customerId : null
            }]));
            setPricing({
                isCustomerSpecific: false,
                customerId: null,
                        ...
                        <div className="fixed inset-0 overflow-y-auto">
                            ...
                            >
                                ...
                                >
                                    <Dialog.Panel
                                        className={`w-full transform overflow-hidden rounded-md
                                                        text-left align-middle shadow-xl transition-alll max-w-5xl ${isDark ? "bg-darkSecondary text-white" : "bg-light"}`}
                                    >
                                        <div
                                            className={`relative overflow-hidden py-4 px-5 text-lightModalHeaderColor flex justify-between bg-white border-b border-lightBorderColor dark:bg-darkInput dark:border-b dark:border-darkSecondary `}
                                        >
                                        ...
                                        >
                                            ...
                                            {
                                                isViewed ? "" :
                                                    <div className=" my-4 border-dashed border-emerald-300 border-2 rounded-md mx-4 px-2">
                                                        <div className="grid  md:grid-cols-2 grid-cols-1   my-4 py-2 px-2  gap-5 ">
                                                            <div className="">
                                                                <label>
                                                                    <p className={`mb-1 ${isDark ? "text-white" : "text-black"}`}>
                                                                        Quantity(+) <span className="text-red-500">*</span>
                                                            ...
                                                            <div className=''>
                                                                ...
                                                                <div
                                                                    className={`w-10 h-5 flex items-center rounded-full p-1 cursor-pointer ${pricing?.isCustomerSpecific ? "bg-lightBtn" : "bg-gray-500"
                                                                        }`}
                                                                    onClick={() => setPricing((prev) => {
                                                                        return {
                                                                            ...prev,
                                                                ...
                                                                >
                                                                    <div
                                                                        className={`w-4 h-4 bg-white rounded-full shadow-md transform ${pricing?.isCustomerSpecific ? "translate-x-4" : "translate-x-0"
                                                                            }`}
                                                                    ></div>
                                                                </div>
                                                                ...
                                                                <div className="">
                                                                    <label>
                                                                        ...
                                                                        >
                                                                            ...
                                                                            {customers &&
                                                                                customers?.map((item) => (
                                                                                    <option value={item?._id} key={item?._id}>{item && item?.firstName+" "+ `(${item?.email})`}</option>
                                                                                ))}
                                                                        </select>
                                                                        {<p className="text-red-600  text-xs"> {pricingError?.customerId ? pricingError?.customerId : ""}</p>}
                                                                    </label>
                                                                </div>
                                                            )}
                                                                    ...
                                                                    pricingArray.map((item, ind) => {
                                                                        return (
                                                                            <tr key={ind} className="border-b border-dashed border-lighttableBorderColor">
                                                                                ...
                                                                                <td className="px-6 py-4 whitespace-nowrap text-start text-sm text-tableTextColor dark:text-white">
                                                                                    {item?.isCustomerSpecific ? customers.find(c => c._id === item.customerId)?.email || "Unknown" : "General"}
                                                                                </td>
