...
const CreateEmployee = ({ noFade, scrollContent }) => {
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2  gap-5 ">
                                        ...
                                        <label className={`fromGroup   ${formDataErr?.roleId !== "" ? "has-error" : ""
                                            ...
                                            <select
                                                ...
                                                onChange={handleChange}
                                                disabled={isViewed}
                                                name="roleId" className="form-control outline-none w-[100%] rounded-md px-4 py-2.5 border border-lightborderInputColor dark:border-darkSecondary text-lightinputTextColor dark:placeholder-darkPlaceholder bg-lightBgInputColor dark:bg-darkIconAndSearchBg dark:text-white"
                                            >
