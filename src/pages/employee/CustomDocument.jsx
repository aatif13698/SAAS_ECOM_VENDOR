...
function CustomDocument({ roleId, userId, noFade }) {
                    ...
                    <>
                        ...
                        {typeof (customizationValues[fieldName]) === "string" && (
                            <div className="mt-2">
                                <img
                                    onClick={() => {
                                        setCurrentImagePreview(customizationValues[fieldName])
                                        setCropModalOpen(true);
                                    }}
    ...
    return (
        <div>
            ...
            <Transition appear show={cropModalOpen} as={Fragment}>
                <Dialog
                    as="div"
                            ...
                            >
                                <Dialog.Panel
                                    className={`w-full transform overflow-hidden rounded-md
                                        text-left align-middle shadow-xl transition-alll max-w-7xl ${isDark ? "bg-darkSecondary text-white" : "bg-light"}`}
                                >
                                    <div
                                    ...
                                    >
                                        ...
                                        <button onClick={handleCropCancel} className=" text-lightmodalCrosscolor hover:text-lightmodalbtnText text-[22px]">
      ...
      >
        <h2 className="text-lg font-semibold mb-4">File Previewß</h2>
