...
const LeaveAllotment = ({ noFade, scrollContent }) => {
    ...
    const onSubmit = async (e) => {
        ...
        if (allotments.some((a) => a.id === "")) {
            toast.error("Please select a leave category for all allotments.");
            setLoading(false);
            return;
        }
        setLoading(true);
                            ...
                            <div className={`${isDark ? "bg-darkSecondary text-white" : "bg-white text-black-900"} p-5 shadow-lg`}>
                                <form onSubmit={onSubmit}>
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5 ">
                                        {/* select level */}
                                        <div
                                            className={`formGroup ${formDataErr?.level !== "" ? "has-error" : ""
                                                } `}
                                        >
                                            <label htmlFor="level" className="form-label ">
                                                <p className="form-label">
                                        ...
                                        </div>
                                        {
                                            (levelResult == 0 || levelResult == 1) ? "" :
                                                <div
                                                    className={`formGroup ${formDataErr?.businessUnit !== "" ? "has-error" : ""
                                                        } `}
                                                >
                                        ...
                                        }
                                        {
                                            (levelResult == 0 || levelResult == 1 || levelResult == 2) ? "" :
                                                <div
                                                    className={`formGroup ${formDataErr?.branch !== "" ? "has-error" : ""
                                                        } `}
                                                >
                                        ...
                                        }
                                        {
                                            (levelResult == 0 || levelResult == 1 || levelResult == 2 || levelResult == 3) ? "" :
                                                <div
                                                    className={`formGroup ${formDataErr?.warehouse !== "" ? "has-error" : ""
                                                        } `}
                                                >
                                        ...
                                        }
                                        {
                                            departments?.length > 0 ?
                                                <>
                                                    <div
                                                        className={`formGroup md:col-span-2 ${formDataErr?.workingDepartment !== "" ? "has-error" : ""
                                                            } `}
                                                    >
                                                        <label htmlFor="workingDepartment" className="form-label ">
                                                            <p className="form-label">
                                                                Department <span className="text-red-500">*</span>
                                                            </p>
                                                        </label>
                                                    ...
                                                    return (
                                                        <div key={index} className="grid grid-cols-3 gap-4 mb-4">
                                                            <div className={`formGroup `}>
                                                                <label htmlFor={`category-${index}`} className="form-label ">Select Leave Category</label>
                                                                <select
                                                                    className="form-control py-2 appearance-none relative flex-1"
                                                                    name={`category-${index}`}
                                                                    id={`category-${index}`}
                                                                ...
                                                                >
                                                                    <option value="">Select one</option>
                                                                    {
                                                                        leaveCategories && leaveCategories?.length > 0 && leaveCategories.filter(cat => 
                                                                            !allotments.some((a, i) => i !== index && a.id === cat._id)
                                                                        ).map((cat) => {
                                                                            return (
                                                                                <option key={cat?._id} value={cat?._id}>{cat?.name}</option>
                                                                            )
                                                            ...
                                                            <div className={`formGroup `}>
                                                                <label className="form-label " htmlFor={`allocated-${index}`}>Days</label>
                                                                <input
                                                                    id={`allocated-${index}`}
                                                                    className="form-control py-2 appearance-none relative flex-1"
                                                                    type="number"
