...
// import salePaymentInConfigureService from '@/services/purchasePaymentConfig.service'; // create this
...
const SaleAndLedger = () => {
    ...
    const loadData = async (currentLevel, levelId) => {
        ...
        try {
            ...
            const configures = await salePaymentInConfigureService.getConfigure(currentLevel, levelId);
            ...
            // const configRes = await salePaymentInConfigureService.getConfigs(currentLevel, levelId);
    ...
    const saveAll = async () => {
        ...
        try {
            ...
            if (cashMethods.length > 0) {
                ...
                await salePaymentInConfigureService.upsert(dataObject);
            }
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
                ...
                {methods.length === 0 && (
                    <div className="text-center py-10 text-gray-500 italic">
                        No {type} received methods configured yet
                    </div>
                )}
    ...
    return (
        <div className="mx-auto py-8 px-4">
            <h2 className="text-2xl font-bold text-gray-800 mb-8">Received Methods Configuration</h2>
            ...
            {loading ? (
                ...
                <div className="space-y-10  ">
                    ...
                    <div className='grid grid-cols-1 md:grid-cols-1 mb-4 gap-5 bg-gray-100 px-4 py-4 rounded-lg'>
                        {renderSection('Cash Received Methods', 'cash', cashMethods, availableCash)}
                        {renderSection('Bank Received Methods', 'bank', bankMethods, availableBank)}
                    </div>
