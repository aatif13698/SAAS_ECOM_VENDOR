...
//     const id = location?.state?.supplierId;
...
//     const [suppliersItemsList, setSupplierItemsList] = useState([]);
...
//                 setSupplierItemsList(res?.data?.items)
//             } catch (e) {
//                 console.log("error while getting supplier items", e);
...
//     const toggleSelect = async (variant, stock) => {
...
//         }
//         const res = await stockService.addItem(dataObject);
...
//                                 Linked Items ({suppliersItemsList.length})
//                             </h3>
//                             <button
//                                 onClick={() => navigate("/create-supplier/link/items", { state: { customerId: currentSupplierId } })}
...
//                         {paginationData && paginationData?.length > 0 ? paginationData.map((stock) => (
//                             <div
//                                 key={stock._id}
...
/* --------------------------------------------------------------
   LinkedItems – fully functional
   -------------------------------------------------------------- */
/* --------------------------------------------------------------
   LinkedItems – fully functional, matches backend shape
   -------------------------------------------------------------- */
import React, {
    useCallback,
    useEffect,
