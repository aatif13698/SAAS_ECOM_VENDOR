...
function Brand({ centered, noFade, scrollContent }) {
    ...
    const debounceSearch = useCallback(
        debounceFunction(
            async (nextValue) => {
                try {
                    setPending(true)
                    const response = await brandService.getAllList({ page, keyword: nextValue, perPage })
        ...
        if (!isError) {
            ...
            if (id) {
                try {
                    ...
                    const response = await brandService.update(formData)
                    closeModal()
    ...
    async function deleteOne({ id, page, keyword: keyWord, perPage }) {
        try {
            const response = await brandService.deleteOne({ id, page, keyword: keyWord, perPage });
    ...
    const handleActive = async (row) => {
        ...
        try {
            const response = await brandService.activeInActive({ id, status, page, keyword: keyWord, perPage });
    ...
    async function getAllList(data) {
        try {
            const response = await brandService.getAllList(data)
            setPaginationData(response?.data?.brands)
            setTotalRows(response?.data?.count)
            setPending(false)
        } catch (error) {
    ...
    const handlePerRowChange = async (perPage) => {
        try {
            const response = await brandService.getAllList({ page, keyword: keyWord, perPage })
            setPaginationData(response?.data?.brands)
            setTotalRows(response?.data?.count)
            setPerPage(perPage)
            setPending(false)
