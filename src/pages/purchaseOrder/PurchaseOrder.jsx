                    ...
                    <tr className="bg-gray-200 dark:bg-gray-800">
                      ...
                      <th className="py-2 px-4 border border-gray-300 text-left text-xs font-medium text-gray-700 dark:text-gray-300 uppercase tracking-wider">Taxable Amt</th>
                      {
                        formData?.isInterState ?
                          <>
                            <th className="py-2 px-4 border border-gray-300 text-left text-xs font-medium text-gray-700 dark:text-gray-300 uppercase tracking-wider">CGST (%)</th>
                            <th className="py-2 px-4 border border-gray-300 text-left text-xs font-medium text-gray-700 dark:text-gray-300 uppercase tracking-wider">SGST (%)</th>
                          </>
                          :
                          <>
                            <th className="py-2 px-4 border border-gray-300 text-left text-xs font-medium text-gray-700 dark:text-gray-300 uppercase tracking-wider">IGST (%)</th>
                          </>
                      }
                      ...
                      <tr key={index} className="hover:bg-gray-50 dark:hover:bg-gray-800">
                        ...
                        <td className="py-2 px-4 border border-gray-300">
                          <input
                            ...
                            name="quantity"
                            value={item.quantity}
                            // disabled={!item?.productMainStock}
