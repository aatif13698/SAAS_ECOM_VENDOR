...
const CreditNote = ({ noFade, scrollContent }) => {
    ...
    const purhcaseOrderDraftData = useSelector((state) => state.creditNoteSlice);
    ...
    async function getNextSerial() {
        try {
            ...
            const response = await transactionSeriesService.getNextSerialNumber(financialYear, "credit_note");
    ...
    async function getSupplierPurchaseInvoice(id) {
        try {
            const response = await creditNoteService.getAll(id);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const dataObject = {
                ...
                cnNumber: formData?.poNumber,
                cnDate: formData?.poDate,
            ...
            const response = await creditNoteService?.create(dataObject);
            ...
            console.log("error while submitting the credit note", message);
        }
    };
    ...
    return (
        <div className=' bg-white dark:bg-darkSecondary rounded-lg relative'>
            ...
            <div className='bg-white shadow-sm flex gap-2 justify-between dark:bg-darkSecondary sticky z-[99] top-[3.54rem] p-4  border-b-2'>
                ...
                <div>
                    <h2 className="text-xl font-semibold   text-gray-700">Create Credit Note</h2>
                </div>
                            ...
                            <div className="bg-white dark:bg-transparent lg:col-span-1 md:col-span-2 rounded-lg border border-gray-200">
                                ...
                                <div className="h-[80%] p-2 grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <div className='relative'>
                                        <label className="block text-sm font-medium text-gray-700 mb-1">Select Sale Inv.</label>
                                        <button
                                            type="button"
