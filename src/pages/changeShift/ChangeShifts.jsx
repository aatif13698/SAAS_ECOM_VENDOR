...
const ChangeShifts = ({ noFade, scrollContent }) => {
    ...
    const handleActive = async (row) => {
        ...
        try {
            ...
            const response = await changeShiftService.activeInactive(dataObject);
    ...
    async function getList() {
        try {
            const response = await changeShiftService.getList(page, keyWord, perPage, currentLevel, levelId);
            setTotalRows(response?.data?.count);
