...
const ViewPaymentOut = () => {
    ...
    const fetchPaymentOut = async (decryptedId) => {
        try {
            setLoading(true);
            const response = await purchasePaymentConfigureService.getParticularPaymentOut(decryptedId);
            ...
            <div className="sticky top-14 z-10 bg-white dark:bg-gray-800 p-3 flex justify-between items-center shadow-md">
                <div>
                    ...
                    <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
                        Date: {formatDate(paymentOutDate)}
                    </p>
                </div>
                    ...
                    <div className="bg-gray-50 dark:bg-gray-800/40 border border-gray-200 dark:border-gray-700 rounded-lg p-5">
                        ...
                        {supplier ? (
                            <div className="space-y-2 text-sm">
                                ...
                                {supplier.GstVanNumber && (
                                    <div>
                                        <span className="font-medium">GSTIN:</span> {supplier.GstVanNumber}
                                    </div>
                                )}
                            </div>
                        ) : (
                            <div className="text-gray-500 dark:text-gray-400 italic">No supplier selected</div>
                        )}
                    </div>
                    ...
                    <div className="bg-gray-50 dark:bg-gray-800/40 border border-gray-200 dark:border-gray-700 rounded-lg p-5">
                        ...
                        <div className="grid grid-cols-2 gap-4 text-sm">
                            ...
                            <div>
                                ...
                                <div className="font-medium">{formatDate(paymentOutDate)}</div>
                            </div>
